...
public class PigLatinActivity extends AppCompatActivity implements TextToSpeech.OnInitListener
{
    ...
    protected void onSaveInstanceState(Bundle outState){
        ...
        outState.putString("text", engine.getEnglish());
        outState.putString("translate", engine.getPig());
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState){
        ...
        engine.setEnglish(savedInstanceState.getString("text"));
        engine.translate();
        text.setText(engine.getPig());
    }
}